...
int main(int argc, char **argv) { 
    ...
    printf("Enter your desired number of elements in the linked list: "); 
	...
	selectionSort(a,n); //sorting the linked list

    printf("\n"); //added a new line to make things prettier!

    printf("Sorted Linked list: \n ");  
     
    printArray1(a,n); //printing the sorted linked list
